          ...
          >
            {[
              ...
              },
              {
                ...
                description: "Comprehensive guidelines governing xbe.sh platform usage",
                href: "/terms",
                updated: "Dec 2024"
              },
              {
              ...
              },
              {
                ...
                description: "Our commitment to keeping your data and platform secure",
                href: "/security",
                updated: "Dec 2024"
              }
            ].map((policy, index) => (
              ...
              >
                <div className="relative h-full">
                  <div className="absolute -inset-1 bg-gradient-to-r from-violet-500/20 to-purple-500/20 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-700"></div>
                  <div className="relative bg-slate-800/30 backdrop-blur-2xl border border-white/10 rounded-2xl p-6 h-full group-hover:border-white/20 transition-all duration-500">
                    <h3 className="text-lg font-bold text-white mb-2 font-cal">{policy.title}</h3>
