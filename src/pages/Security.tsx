        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-400 mb-2">
                Robust security framework protecting user data and platform integrity.
              </p>
          ...
          >
            <div className="space-y-12 text-gray-300 leading-relaxed">
              <section>
                <h2 className="text-2xl font-bold text-white mb-6 font-cal">Security Measures & Compliance</h2>
                
                <div className="mb-8">
                  <h3 className="text-xl font-semibold text-white mb-4 font-cal">Infrastructure Security</h3>
                  <p className="mb-4">
                    We follow best practices to safeguard our infrastructure.
                  </p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>SOC 2, ISO 27001, and GDPR compliance</li>
                    <li>Encryption of data in transit and at rest</li>
                    <li>Regular penetration testing and vulnerability assessments</li>
                    <li>Secure cloud hosting with redundant backups</li>
                  </ul>
                </div>

                <div className="mb-8">
                  <h3 className="text-xl font-semibold text-white mb-4 font-cal">Access & Authentication Controls</h3>
                  <p className="mb-4">
                    We implement strict authentication and access management policies.
                  </p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>Multi-factor authentication (MFA) for account security</li>
                    <li>Role-based access control (RBAC) for data governance</li>
                    <li>Real-time monitoring and anomaly detection</li>
                    <li>Regular access audits and least-privilege enforcement</li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="mb-4">
                  For questions regarding this Security Policy or to report security concerns, please contact us:
                </p>
