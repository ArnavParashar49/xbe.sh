        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-400 mb-2">
                Comprehensive tracking technology management and user privacy protection.
              </p>
          ...
          >
            <div className="space-y-12 text-gray-300 leading-relaxed">
              <section>
                <h2 className="text-2xl font-bold text-white mb-6 font-cal">Cookie Usage</h2>
                
                <div className="mb-8">
                  <h3 className="text-xl font-semibold text-white mb-4 font-cal">Essential Cookies</h3>
                  <p className="mb-4">
                    Cookies required for fundamental functionality:
                  </p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>Session persistence and management</li>
                    <li>Authentication tracking and status retention</li>
                    <li>Security enforcement and protection</li>
                    <li>User preference storage</li>
                    <li>Load distribution and system balancing</li>
                  </ul>
                </div>

                <div className="mb-8">
                  <h3 className="text-xl font-semibold text-white mb-4 font-cal">Analytics Cookies</h3>
                  <p className="mb-4">
                    Cookies that help analyze user engagement:
                  </p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>Traffic and interaction patterns</li>
                    <li>Feature adoption and effectiveness</li>
                    <li>Performance metrics tracking</li>
                    <li>Error detection and troubleshooting</li>
                    <li>User journey mapping and insights</li>
                  </ul>
                </div>

                <div className="mb-8">
                  <h3 className="text-xl font-semibold text-white mb-4 font-cal">Advertising & Third-Party Cookies</h3>
                  <p className="mb-4">
                    We may use third-party cookies for marketing and analytics.
                  </p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>Personalized content recommendations</li>
                    <li>Ad targeting and performance tracking</li>
              ...
              <section>
                ...
                <p className="mb-4">
                  For questions regarding this Cookie Policy or tracking technologies, please contact us:
                </p>
